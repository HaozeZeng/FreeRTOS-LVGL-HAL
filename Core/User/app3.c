...
static lv_style_t label_style;									// ����һ�����
...
//    lv_style_init(&label_style);									// ��ʼ�����
//    lv_style_set_text_font(&label_style, &myFont);// ���÷�������
//
//    lv_obj_t * textlabel = lv_label_create(lv_scr_act());			// ������Ļ����һ����ǩ
//    lv_label_set_long_mode(textlabel,LV_LABEL_LONG_WRAP );				// ��ǩ�����ݿ򣬱��ֿؼ���ȣ����ݹ����ͻ���
//    lv_obj_set_width(textlabel, 320);									// ���ñ�ǩ���
//    lv_label_set_recolor(textlabel, true);								// ʹ���ַ��������¶��ַ���ɫ
//    lv_label_set_text(textlabel, "����SD���ֿ�Ŷ,����SD������123abcABC");	// ������ʾ�ı�
//    lv_obj_align(textlabel, LV_ALIGN_CENTER, 0, -60);				// ���뵽����ƫ��
//    lv_obj_add_style(textlabel, &label_style,LV_PART_MAIN);		// Ӧ��Ч�����
//    //lv_obj_t * List = lv_list_create(lv_scr_act());

//    lv_obj_t *lb = lv_label_create(lv_scr_act());
//    lv_obj_set_style_text_font(lb, &yahei16, 0);
//    lv_label_set_text(lb, "你");
//    lv_obj_center(lb);
