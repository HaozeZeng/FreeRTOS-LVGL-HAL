...
FRESULT f_mount (
	FATFS* fs,			/* Pointer to the file system object (NULL:unmount)*/             		/*文件系统对象的指针(NULL:unmount)*/   
...
FRESULT f_mkfs (													
	const TCHAR* path,	/* Logical drive number */								/*逻辑盘号*/
	BYTE sfd,			/* Partitioning rule 0:FDISK, 1:SFD */                  /*分区规则0:FDISK, 1:SFD */
	UINT au				/* Size of allocation unit in unit of byte or sector */ /*以字节或扇区为单位的分配单元大小*/
)
/*逻辑盘号*/
/*分区规则0:FDISK, 1:SFD */
/*以字节或扇区为单位的分配单元大小*/
